...
@Stable
internal class MediaControllerProbe internal constructor(context: Context){
    ...
    companion object{
        @Volatile
        private var instance: MediaControllerProbe? = null

        fun getInstance(context: Context): MediaControllerProbe{
            return instance?:synchronized(this) {
                instance?: MediaControllerProbe(context).also { instance = it }
            }
        }
    }
}